...
namespace Mobile_Banking
{
    public partial class Form10 : Form
    {
        ...
        public string passvalue(ref string b)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "")
            {
                ...
                cmd4.Parameters.AddWithValue("@USER_TYPE", "Personal User");
                con.Open();
                ...
                if (cmd4.ExecuteScalar() != null&&m)
                {
                    ...
                    if (Ppn >= A)
                    {
                        ...
                        if (a > 0 && b > 0)
                        {
                            ...
                            cmd6.Parameters.AddWithValue("@TYPE", " Cash In  ");
                        ...
                        {
                            MessageBox.Show("Cash In UnSuccessful");
                        }
                    }
                    else
                    {
